export function TimelinePanel() {
  return (
    <div className="bg-surface border-[3px] border-outline flex flex-col brutalist-shadow h-full w-full">
      <div className="p-6 border-b-2 border-outline flex justify-between items-center bg-black shrink-0">
        ...
        <span className="flex items-center gap-2 text-primary-fixed font-black uppercase italic text-sm">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-8 space-y-8 relative">
        <div className="absolute left-[47px] top-8 bottom-8 w-[2px] bg-outline-variant"></div>
        ...
        <div className="relative pl-12">
          ...
          <div className="bg-black border-2 border-outline-variant p-3 flex items-center justify-between">
        ...
        <div className="relative pl-12">
          ...
          <div className="bg-primary-fixed/10 border-2 border-primary-fixed p-3 flex items-center justify-between">
