    ...
    <footer className="h-24 bg-surface-container-high border-t-[3px] border-primary-fixed px-gutter flex items-center gap-4 md:gap-8 shrink-0 relative z-20">
      ...
      <div className="flex-1 flex flex-col gap-2">
        <div className="flex justify-between font-mono-label text-[10px] md:text-mono-label">
          <span className="text-primary-fixed font-black">REPLAYING TURN 3 OF 4...</span>
          <span className="text-on-surface-variant">00:03:14 / 00:04:12</span>
        </div>
        
        <div className="w-full h-4 bg-background border-2 border-outline-variant relative overflow-hidden">
          {/* Progress */}
          <div className="absolute top-0 left-0 h-full bg-primary-fixed" style={{ width: "75%" }}></div>
          
          {/* Markers */}
          <div className="absolute top-0 left-[15%] w-1 h-full bg-surface-variant border-x border-background"></div>
          <div className="absolute top-0 left-[40%] w-1 h-full bg-surface-variant border-x border-background"></div>
          <div className="absolute top-0 left-[75%] w-1.5 h-full bg-white z-10 shadow-[0_0_10px_#fff]"></div>
          <div className="absolute top-0 left-[90%] w-1 h-full bg-surface-variant border-x border-background"></div>
        </div>
      </div>
      
      <div className="hidden lg:flex flex-col items-end gap-1">
        <span className="font-mono-label text-[10px] opacity-60">ENCODING_BITRATE</span>
        <span className="font-mono-label text-mono-label text-primary-fixed">12.4 MBPS</span>
      </div>
    </footer>
  );
}
