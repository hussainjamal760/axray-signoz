    ...
    <div className="min-h-screen bg-background relative selection:bg-primary-fixed selection:text-black overflow-hidden">
      ...
      <main className="relative z-10 pt-48 pb-24 px-margin max-w-4xl mx-auto">
        ...
        <h1 className="font-headline-xl text-5xl md:text-7xl uppercase text-white font-black mb-12 tracking-tighter">
          Security <span className="text-primary-fixed">Overview</span>
        </h1>
        <div className="bg-surface-container border-[4px] border-black p-8 md:p-12 shadow-[8px_8px_0px_0px_#000]">
          <div className="prose prose-invert prose-lg max-w-none font-body-md text-on-surface-variant">
            <p className="font-bold text-white mb-6">Built for mission-critical telemetry.</p>
            
            <h2 className="text-primary-fixed font-black uppercase tracking-widest text-xl mt-8 mb-4 border-b-[3px] border-black pb-2 inline-block bg-black px-4 pt-2 shadow-[4px_4px_0px_0px_theme(colors.primary-fixed)]">1. Data Encryption</h2>
            <p className="mt-6 mb-8 text-lg font-medium leading-relaxed">All telemetry data, traces, and metrics sent to AXRAY are encrypted in transit using TLS 1.3 and at rest using AES-256. We ensure that no unencrypted telemetry traverses the public internet.</p>

            <div className="h-[3px] w-full bg-outline-variant/30 my-10"></div>

            <h2 className="text-primary-fixed font-black uppercase tracking-widest text-xl mt-8 mb-4 border-b-[3px] border-black pb-2 inline-block bg-black px-4 pt-2 shadow-[4px_4px_0px_0px_theme(colors.primary-fixed)]">2. Compliance & SOC2</h2>
            <p className="mt-6 mb-8 text-lg font-medium leading-relaxed">We leverage SigNoz Cloud as our backend, which is SOC2 Type II compliant. This ensures that the underlying infrastructure follows the most stringent security and availability standards.</p>

            <div className="h-[3px] w-full bg-outline-variant/30 my-10"></div>

            <h2 className="text-primary-fixed font-black uppercase tracking-widest text-xl mt-8 mb-4 border-b-[3px] border-black pb-2 inline-block bg-black px-4 pt-2 shadow-[4px_4px_0px_0px_theme(colors.primary-fixed)]">3. Vulnerability Disclosure</h2>
            <p className="mt-6 mb-8 text-lg font-medium leading-relaxed">We welcome security researchers to test our application. If you believe you have found a security vulnerability in AXRAY, please submit a report to security@axray.dev. We aim to respond within 24 hours.</p>
