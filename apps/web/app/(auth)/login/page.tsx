...
import { GithubLogo, ShieldCheck, LockKey, Key, GitBranch, Cpu, CodeSimple, Database } from "@phosphor-icons/react/dist/ssr";

export default function LoginPage() {
  return (
    <div className="min-h-screen flex flex-col bg-background font-geist selection:bg-primary-fixed selection:text-on-primary relative overflow-hidden">
      ...
      <header className="w-full top-0 sticky z-50 bg-background/95 backdrop-blur-sm border-b-[3px] border-on-background shadow-sm">
        <div className="flex justify-between items-center w-full px-margin py-4 max-w-full mx-auto">
          ...
          <div className="hidden md:flex gap-8 items-center bg-surface-container border-2 border-on-background px-6 py-2 shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:shadow-none hover:translate-y-[2px] hover:translate-x-[2px] transition-all">
            <Link className="text-on-surface-variant font-mono-label text-mono-label uppercase hover:text-primary-fixed transition-colors" href="/">
              Return to Home
            </Link>
          </div>
        </div>
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-12 w-full max-w-[1400px] mx-auto">
        ...
        <div className="border-[3px] border-on-background bg-[#181912] shadow-block relative z-10 w-full flex flex-col lg:flex-row overflow-hidden">
          ...
          <div className="flex-1 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
            ...
            {/* GitHub Auth Button */}
            <button className="w-full max-w-md flex items-center justify-center gap-3 bg-primary-fixed text-on-primary border-[3px] border-on-background px-6 py-5 font-cta-label text-xl uppercase shadow-block hover:shadow-block-hover hover:-translate-y-1 active:translate-y-1 active:shadow-none transition-all mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-lg mb-8">
              <div className="bg-surface-container-low p-4 border-2 border-on-background/20 hover:border-primary-fixed/50 transition-colors group">
                <ShieldCheck weight="bold" className="text-primary-fixed w-6 h-6 mb-2 group-hover:scale-110 transition-transform" />
                <h4 className="font-mono-label font-bold text-[10px] text-on-background uppercase mb-1">10k+ Engineers</h4>
              </div>
              <div className="bg-surface-container-low p-4 border-2 border-on-background/20 hover:border-primary-fixed/50 transition-colors group">
                <LockKey weight="bold" className="text-primary-fixed w-6 h-6 mb-2 group-hover:scale-110 transition-transform" />
                <h4 className="font-mono-label font-bold text-[10px] text-on-background uppercase mb-1">SSL Encryption</h4>
              </div>
              <div className="bg-surface-container-low p-4 border-2 border-on-background/20 hover:border-primary-fixed/50 transition-colors group">
                <Key weight="bold" className="text-primary-fixed w-6 h-6 mb-2 group-hover:scale-110 transition-transform" />
                <h4 className="font-mono-label font-bold text-[10px] text-on-background uppercase mb-1">OAuth 2.0</h4>
              </div>
            </div>

            {/* Footer Text */}
            <p className="font-mono-label text-[9px] text-on-surface-variant/60 uppercase leading-relaxed max-w-sm">
              By continuing, you agree to our <Link href="#" className="text-primary-fixed font-bold hover:underline">Terms of Service</Link> and <Link href="#" className="text-primary-fixed font-bold hover:underline">Privacy Policy</Link>.
            </p>

          </div>

          {/* Right Side: Visuals / Simulation (Takes up less space, but adds high density) */}
          <div className="w-full lg:w-[45%] border-t-[3px] lg:border-t-0 lg:border-l-[3px] border-on-background bg-surface-container flex flex-col">
            ...
            <div className="flex border-b-[3px] border-on-background">
              <div className="flex-1 p-4 border-r-[3px] border-on-background bg-surface-container-high flex items-center gap-3">
                ...
                <span className="font-mono-label text-[10px] uppercase tracking-widest">Agent Core Active</span>
              </div>
            ...
            <div className="flex-1 p-6 flex flex-col gap-6 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4 relative z-10">
                <div className="border-2 border-on-background/30 p-3 bg-background/50 backdrop-blur-sm">
                  ...
                  <div className="font-mono-label text-[9px] text-on-surface-variant uppercase mb-1">Vector DB</div>
                ...
                <div className="border-2 border-on-background/30 p-3 bg-background/50 backdrop-blur-sm">
                  ...
                  <div className="font-mono-label text-[9px] text-on-surface-variant uppercase mb-1">Pull Requests</div>
              ...
              <div className="flex-1 border-2 border-on-background shadow-inner bg-background relative overflow-hidden flex flex-col justify-center items-center p-8 text-center group">
                ...
                <p className="font-mono-label text-sm text-on-surface-variant/80 leading-relaxed max-w-sm uppercase tracking-widest">
                  Just a few clicks away from unlocking complete observability. Connect your identity to start tracing, debugging, and controlling your autonomous agents with surgical precision.
                </p>
